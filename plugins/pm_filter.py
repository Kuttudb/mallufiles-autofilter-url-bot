...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🌐 Website', url='https://mallufiles.ga'),
            InlineKeyboardButton('🤖 Updates', url='https://t.me/mallufiles')
        ], [
            InlineKeyboardButton('🔍 Search', switch_inline_query_current_chat=''),
            InlineKeyboardButton('📤 Share', url='https://t.me/share/url?url=t.me/cyclonickfilterbot')
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('📝 Mannual Filter', callback_data='manuelfilter'),
            InlineKeyboardButton('🗒️ Auto Filter', callback_data='autofilter')
        ], [
            InlineKeyboardButton('🔌 Connections', callback_data='coct'),
            InlineKeyboardButton('🛠️ Extra Mods', callback_data='extra')
        ], [
